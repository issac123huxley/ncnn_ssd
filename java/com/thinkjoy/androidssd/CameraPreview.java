...
public class CameraPreview extends SurfaceView implements SurfaceHolder.Callback, Camera.PreviewCallback{
    ...
    public CameraPreview(Context context, AttributeSet attrs) {
        ...
        mInterface = NativeInterface.getInstance(getContext());
    }
...
//            }
            if (data != null  && faceOverlayView != null) {

                List<Object> list_object = new ArrayList<>();
                long time1 = System.currentTimeMillis();
                mInterface.detect(data, 0, 1, previewSize.width, previewSize.height, list_object);
                long time2 = System.currentTimeMillis();
                Log.i("Camera", "width:" + previewSize.width + " height:" + previewSize.height);
                faceOverlayView.setImageSize(previewSize.width, previewSize.height);
                faceOverlayView.setObjectList(list_object, (int)(time2 - time1));
                Log.i("Time", Long.toString(time2 - time1));
